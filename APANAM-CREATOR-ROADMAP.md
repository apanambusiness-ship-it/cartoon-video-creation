...
- On 21 September, the public editor exported a 1080 × 1080 PNG and video-only WebM files at 1280 × 720 and 720 × 1280. After export timing fixes, a synthetic WAV added to one scene produced a 4.98-second WebM with VP9 video and Opus audio; measured mean audio was -35.5 dB and peak was -28.4 dB. The narrated export therefore passed this automated Chromium check. A real Chrome device should still verify audible playback.
