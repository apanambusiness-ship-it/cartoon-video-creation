...
export default function Home() {
  return <main>
    ...
    <section id="price" className="pricing"><div><p className="eyebrow">CREATOR PLAN</p><h2>₹299 <small>/ month</small></h2><p>Serious Indian creators ke liye simple, affordable plan.</p></div><div><ul><li>Monthly creation credits</li><li>Cartoon video & poster concepts</li><li>Hindi, Hinglish & English support</li><li>Creator dashboard</li></ul><Link className="button dark" href="/studio">Start creating →</Link></div></section>
    <footer><Link href="/" className="brand"><span>T</span>ToonSutra <i>AI</i></Link><p>Stories deserve to move.</p><p>© 2026 ToonSutra AI</p></footer>
  </main>;
}
