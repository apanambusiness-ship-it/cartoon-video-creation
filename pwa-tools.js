(()=>{
  ...
  const button=document.createElement('button');button.type='button';button.id='apanamInstallApp';button.textContent='⬇ Install App';button.hidden=true;button.title='APANAM Studio को इस device पर install करें';
